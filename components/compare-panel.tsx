    ...
    >
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h3 className="font-display text-2xl text-white md:text-3xl">What changes</h3>
      ...
      <div className="grid gap-3">
        {primary.categories.map((category, index) => {
          ...
          return (
            <div key={category.key} className="rounded-[14px] border border-white/10 bg-white/[0.02] p-4">
              <div className="mb-2 flex items-center justify-between gap-3">
                <div className="text-sm font-medium text-white">{category.label}</div>
                <div className="inline-flex items-center gap-2 rounded-full bg-black/10 px-3 py-1 text-xs text-slate-300">
